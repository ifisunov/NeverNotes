...
namespace MyNotes
{
    ...
    /// <summary>
    /// Мой класс переопределяющий UserValidator для регистрации пользователя только по e-mail
    /// </summary>
